<div class="form">
    ...
    <fieldset>
        ...
        <?php echo $form->dropDownListRow($model, 'category_id', $this->parent, array('label' => '分类')); ?>
        ...
        <?php if (!$model->isNewRecord) { ?>
            ...
            <h3>关键属性</h3>
            <?php
            $cri = new CDbCriteria(array('condition' => 'is_key_prop=1 and category_id =' . $model->category->parent->category_id));
