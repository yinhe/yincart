    ...
    <div class="span2">
        ...
        $this->widget('bootstrap.widgets.TbMenu', array(
            ...
            'items' => array_merge(array(
                ...
                array('label' => '商品类型', 'icon' => 'bookmark', 'url' => array('/mall/itemType/admin')),
                array('label' => '商品属性', 'icon' => 'list-alt', 'url' => array('/mall/itemProp/admin')),
//                array('label' => '商品规格', 'icon' => 'list-alt', 'url' => array('/mall/specification/admin')),
                array('label' => '商品列表', 'icon' => 'list-alt', 'url' => array('/mall/item/admin')),
//                array('label' => '品牌列表', 'icon' => 'star', 'url' => array('/mall/brand/admin')),
                '---',
                array('label' => 'PAYMENT'),
