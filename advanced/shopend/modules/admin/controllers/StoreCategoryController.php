...
// move
    ...
    public function actionDelete($id) {
        if (Yii::app()->request->isPostRequest) {
            ...
            $model = $this->loadModel($id);
            $image = dirname(Yii::app()->basePath) . '/upload/storeCategory/'. $model->pic;
    ...
    {
        $dataProvider = new CActiveDataProvider('StoreCategory');
     ...
     * @param StoreCategory $model the model to be validated
     */
