...
<?php echo $form->dropDownListRow($model, 'category_id', $model->attrCategory(3)); ?>
<?php echo $form->dropDownListRow($model, 'parent_prop_id', $props); ?>
<?php echo $form->textFieldRow($model, 'prop_name'); ?>
<?php echo $form->textFieldRow($model, 'prop_alias'); ?>
<?php echo $form->radioButtonListRow($model, 'type', $model->attrType(), array('labelOptions' => array('class' => 'radio inline'))); ?>
<?php foreach (array('is_key_prop', 'is_sale_prop', 'is_color_prop', 'is_enum_prop', 'is_item_prop', 'must', 'multi', 'status') as $v) {
    echo $form->dropDownListRow($model, $v, $model->attrBool($v));
}
?>
