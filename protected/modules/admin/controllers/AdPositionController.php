...
class AdPositionController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('AdPosition');
	...
	{
		$model=new AdPosition('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AdPosition']))
			$model->attributes=$_GET['AdPosition'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ad-position-form')
		{
